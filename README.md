...
SHAP 해석을 통해 어떤 변수들이 이탈 예측에 영향을 주는지도 확인했습니다.

**Length of Stay**, **Type of Admission**, **Severity of Illness** 등이 주요 변수로 작용함을 확인했습니다.
